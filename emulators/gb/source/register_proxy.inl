...
namespace bolt {
    ...
    gb_register_proxy<gb_register_type>::gb_register_proxy(gb_cpu *cpu, gb_register8_t *register_high, gb_register8_t *register_low)
    ...
    template<typename gb_register_type>
    inline gb_register_proxy<gb_register_type>::gb_register_proxy(gb_cpu *cpu, gb_register_t *register_t)
